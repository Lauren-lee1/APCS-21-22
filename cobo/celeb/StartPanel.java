...
public class StartPanel extends JPanel
{
  ...
  private JRadioButton Robert;
  private String KXiao;
  /**
  ...
  private String entrepreneurClue;
  ...
  private boolean validate(String answerText, String clueText)
  {
    ...
    } else if(Robert.isSelected()){
      validClue = controller.validateClue(clueText, "Entrepreneur");
    }
    else
    {
  ...
  private void setupLayout()
  {
    ...
    panelLayout.putConstraint(SpringLayout.NORTH, literatureRadio, 10, SpringLayout.SOUTH, Robert);

    panelLayout.putConstraint(SpringLayout.WEST, Robert, 0, SpringLayout.WEST, celebrityRadio);
    panelLayout.putConstraint(SpringLayout.NORTH, Robert, 10, SpringLayout.SOUTH, celebrityRadio);
  ...
  private void setupListeners()
  {
     ...
     *
     */
    Robert.addActionListener(select -> clueLabel.setText(entrepreneurClue));
