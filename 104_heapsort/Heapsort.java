...
DISCO
    - 
QCC
    - We spent 1 hour chasing down a bug that happened to just be a missing = sign
    - Why do we have to overwrite the last leaf with the old root? The last leaf is the old root anyways, so overwriting does nothing
 */
